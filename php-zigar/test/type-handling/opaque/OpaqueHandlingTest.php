...
{   
    public function testImportOpaqueAsStaticVariables(): void
    {
        ...
        $this->assertSame(1, strlen($m->orange_ptr->__bytes));
    ...
    public function testHandleOpaqueAsComptimeField(): void
    {
        ...
        $this->expectOutputRegex('/\.{ \.number = 500, \.ptr = as\-comptime\-field.Opaque@\w+ }/');
        $m->print($b);
    }
    ...
    public function testHandleOpaqueInBareUnion(): void
    {
        ...
        if (ZigImporter::safetyCheck()) {
            $this->assertExceptionMessage("'number' is active", function() use($m, $b) {
                $x = $b->ptr;
            });
        } else {
