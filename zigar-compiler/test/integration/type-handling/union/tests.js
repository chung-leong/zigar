  ...
  describe('Union', function() {
    ...
    it('should import union as static variables', async function() {
      ...
      expect(module.packed_union.valueOf()).to.eql({
        first: { one_bit: true, seven_bits: 127 },
        second: { four_bits: 15, another_four_bits: 15 },
        eight_bits: 255
      });
      module.packed_union.first.one_bit = 0;
      expect(module.packed_union.first.one_bit).to.equal(false);
      expect(module.packed_union.eight_bits).to.equal(254);
      expect(module.packed_union.second.four_bits).to.equal(14);
      module.packed_union.second.another_four_bits = 1;
      expect(module.packed_union.eight_bits).to.equal(30);
    })
