...
export function addTests(importModule, options) {
  ...
  describe('Struct', function() {
    ...
    it('should handle struct in struct', async function() {
      ...
      const [ before ] = await capture(() => print());
      expect(before).to.equal('in-a-struct.StructA{ .struct1 = in-a-struct.Struct{ .number1 = 1, .number2 = 2 }, .struct2 = in-a-struct.Struct{ .number1 = 3, .number2 = 4 } }');
      module.struct_a = b;
      const [ after ] = await capture(() => print());
      expect(after).to.equal('in-a-struct.StructA{ .struct1 = in-a-struct.Struct{ .number1 = 10, .number2 = 20 }, .struct2 = in-a-struct.Struct{ .number1 = 11, .number2 = 21 } }');
    })
    it('should handle struct in packed struct', async function() {
      ...
      const [ before ] = await capture(() => print());
      expect(before).to.equal('in-a-packed-struct.StructA{ .struct1 = in-a-packed-struct.Struct{ .number1 = 1, .number2 = 2 }, .struct2 = in-a-packed-struct.Struct{ .number1 = 3, .number2 = 4 }, .number = 200, .struct3 = in-a-packed-struct.Struct{ .number1 = 5, .number2 = 6 } }');
      module.struct_a = b;
      const [ after ] = await capture(() => print());
      expect(after).to.equal('in-a-packed-struct.StructA{ .struct1 = in-a-packed-struct.Struct{ .number1 = 10, .number2 = 20 }, .struct2 = in-a-packed-struct.Struct{ .number1 = 11, .number2 = 21 }, .number = 100, .struct3 = in-a-packed-struct.Struct{ .number1 = 12, .number2 = 22 } }');
    })
