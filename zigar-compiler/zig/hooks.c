...
MODULE_VISIBILITY int (*vfprintf_chk_orig)(FILE* s, int flag, const char* f, va_list arg) = NULL;
MODULE_VISIBILITY int vfprintf_chk_hook(FILE* s, int flag, const char* f, va_list arg) {
    return vfprintf_hook(s, f, arg);
}

MODULE_VISIBILITY int (*vprintf_chk_orig)(int flag, const char* f, va_list arg) = NULL;
MODULE_VISIBILITY int vprintf_chk_hook(int flag, const char* f, va_list arg) {
    return vfprintf_chk_hook(stdout, flag, f, arg);
}

MODULE_VISIBILITY int (*fprintf_chk_orig)(FILE* s, int flag, const char* f, ...) = NULL;
...
MODULE_VISIBILITY int (*printf_chk_orig)(int flag, const char* f, ...) = NULL;
