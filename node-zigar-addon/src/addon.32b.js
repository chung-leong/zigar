(function(t) {
    ...
    const it = rt("memory"), st = rt("slots"), ot = rt("parent"), ct = rt("zig"), at = rt("name"), lt = rt("type"), ut = rt("flags"), ft = rt("class"), ht = rt("tag"), dt = rt("props"), gt = rt("pointer"), bt = rt("sentinel"), yt = rt("array"), pt = rt("target"), mt = rt("entries"), wt = rt("max length"), vt = rt("keys"), St = rt("address"), At = rt("length"), It = rt("last address"), Vt = rt("last length"), Et = rt("proxy"), Mt = rt("cache"), xt = rt("size"), Ot = rt("bit size"), $t = rt("align"), Tt = rt("const target"), Ut = rt("environment"), zt = rt("attributes"), Ct = rt("primitive"), Bt = rt("getters"), jt = rt("setters"), Ft = rt("typed array"), Nt = rt("throwing"), kt = rt("promise"), Pt = rt("generator"), Lt = rt("allocator"), Dt = rt("fallback"), Rt = rt("signature"), Zt = rt("update"), qt = rt("reset"), Jt = rt("vivificate"), Gt = rt("visit"), _t = rt("copy"), Wt = rt("shape"), Ht = rt("initialize"), Xt = rt("restrict"), Yt = rt("finalize"), Kt = rt("cast"), Qt = rt("return"), te = rt("yield");
    function ee(t, e, n) {
        if (n) {
    ...
    function Me(t) {
        return Ee.constructor || Ee.mixins.push(t), t;
    }
    function xe() {
        return Ee.constructor || (Ee.constructor = function(t, e) {
            const n = [], r = function() {
            ...
            return r;
        }(Ee.name, Ee.mixins), Ee.name = "", Ee.mixins = []), Ee.constructor;
    }
    function Oe(t, e, n) {
        if (t + e <= 8) {
            const r = 2 ** e - 1;
    ...
    class BufferExpected extends TypeError {
        constructor(t) {
            ...
            let c;
            i && o.push(Be(i.name)), c = n === e.Slice ? `Expecting ${Fe(o)} that can accommodate items ${r} byte${s} in length` : `Expecting ${Fe(o)} that is ${r} byte${s} in length`, 
            super(c);
        }
    }
    ...
    class ErrorExpected extends TypeError {
        constructor(t, e) {
            ...
            let i;
            "string" === r || "number" === r || ze(e) ? (ze(e) && (e = `{ error: ${JSON.stringify(e.error)} }`), 
    ...
    class InvalidInitializer extends TypeError {
        constructor(t, e, n) {
            ...
            const s = Ce(n);
            super(`${r} expects ${Fe(i)} as argument, received ${s}`);
        }
    }
    ...
    class ArgumentCountMismatch extends Error {
        constructor(t, e, n = !1) {
            ...
            const r = r => {
                ...
                this.message = `Expecting ${s}${t} argument${i}, received ${e}`, this.stack = Te(this.stack, "new Arg(");
            };
            r(0), ee(this, Zt, {
                value: r,
                enumerable: !1
    ...
    class ZigError extends Error {
        constructor(t, e = 0) {
            if (t instanceof Error) return super(t.message), t.stack = Te(this.stack, e), t;
            super(t ?? "Error encountered in Zig code");
        }
    }
    function $e(t, e) {
        const n = n => {
            e -= n, t.message = `args[${e}]: ${t.message}`, t.stack = Te(t.stack, "new Arg(");
        };
        return n(0), ee(t, Zt, {
            value: n,
            enumerable: !1
    ...
    Me({
        ...
        defineFree() {
            ...
            return {
                value(e) {
                    const {dv: n, align: r} = Ne(e), i = n?.[ct];
        ...
        defineDupe() {
            ...
            return {
                value(e) {
                    const {dv: n, align: r, constructor: i} = Ne(e);
    ...
    const ke = n.map((t => t.replace(/([a-z])([A-Z])/g, "$1 $2").toLowerCase()));
    Me({
        init() {
    ...
    Me({
        ...
        getShadowAddress(t, e, n, r) {
            ...
            if (n) {
                if (void 0 === n.address) {
                    ...
                    const l = s - e, u = this.allocateShadowMemory(l + a, 1), f = this.getViewAddress(u), h = he(ge(f, c - e), a), d = ge(h, e - c);
                    for (const t of o) {
                        const n = t[it], r = n.byteOffset;
                        if (r !== c) {
                            const i = t.constructor[$t] ?? n[$t];
                            if (fe(ge(d, r - e), i)) throw new AlignmentConflict(i, a);
                        }
                    }
                ...
                return ge(n.address, i.byteOffset - n.start);
            }
            {
        ...
        findMemory(t, e, n, r) {
            ...
            let c;
            if (o?.address === e && o.len === i) c = o.targetDV; else if (o?.address <= e && ge(e, i) <= ge(o.address, o.len)) {
        ...
        releaseZigView(t) {
            ...
            n && -1 !== n && (e.address = -1, this.unregisterBuffer(ge(n, -t.byteOffset)));
        },
        getViewAddress(t) {
            const e = t[ct];
        ...
        ...{
            ...
            obtainZigView(t, e, n = !0) {
                ...
                if (n) {
                    ...
                    s?.address <= t && ge(t, e) <= ge(s.address, s.len) ? (r = s.buffer, i = Number(t - s.address)) : (r = e > 0 ? this.obtainExternBuffer(t, e, Dt) : new ArrayBuffer(0), 
                ...
                if (n) {
                    if (void 0 === n.misaligned) {
                        ...
                        for (const e of n.targets) {
                            const r = e[it].byteOffset, i = e.constructor[$t], s = ge(t, r);
                            if (fe(s, i)) {
                                n.misaligned = !0;
                                break;
                            }
                    ...
                    if (!n.misaligned) return ge(n.address, i.byteOffset);
                } else {
        ...
        prepareObjectsForExport() {
            const t = [];
            for (const e of pe(this.structures, st)) {
                const n = e[it]?.[ct];
                if (n) {
            ...
            for (const e of t) if (!e.replaced) for (const n of t) if (e !== n && !n.replaced && !n.handle && e.address <= n.address && ge(n.address, n.len) <= ge(e.address, e.len)) {
                const t = e.owner[it], r = Number(n.address - e.address) + t.byteOffset;
                n.owner[it] = this.obtainView(t.buffer, r, n.len), n.replaced = !0;
            }
        },
        useStructures() {
            const t = this.getRootModule(), e = pe(this.structures, st);
            ...
            !c) {
                ...
                if (r) {
                    ...
                    if (function(t) {
                        ...
                        const {byteSize: o, structure: {constructor: a}} = c, l = ye(n, a);
                        if (void 0 !== l) {
    ...
    function Ge(t, e = []) {
        ...
        for (const [r, i] of Object.entries(n)) i.set && !e.includes(r) && (i.set = Ue, 
        qe(t, r, i));
        qe(t, Tt, {
            value: t
        });
    ...
    function en(t) {
        const e = ie(t), n = this, r = this[dt], i = this[Bt];
        let s = 0;
        return {
            next() {
                let t, o;
    ...
    Me({
        ...
        createApplier(t) {
            ...
            return function(n, r) {
                const i = Object.keys(n), s = this[vt], o = this[jt];
    ...
    Me({
        defineArray(t, e) {
            const {length: n, instance: {members: [r]}, flags: o} = t, c = this.createApplier(t), a = this.defineMember(r), {set: h} = a, d = this.createConstructor(t), g = function(e, r) {
                if (we(e, d)) this[_t](e), o & s && this[Gt]("copy", tt.Vivificate, e); else if ("string" == typeof e && o & l && (e = {
                    string: e
                }), e?.[Symbol.iterator]) {
        ...
        defineEnum(t, e) {
            ...
            return e.$ = r, e.toString = re(Ie), e[Symbol.toPrimitive] = {
                value(t) {
                    switch (t) {
                      case "string":
                      case "default":
        ...
        defineErrorSet(t, n) {
            ...
            return n.$ = s, n[Ht] = re((function(e) {
                if (e instanceof l[ft]) o.call(this, e); else if (e && "object" == typeof e && !ze(e)) {
        ...
        finalizeErrorSet(t, e) {
            ...
            e[Kt] = {
                value: t => "number" == typeof t || "string" == typeof t ? n[t] : t instanceof n[ft] ? n[Number(t)] : ze(t) ? n[`Error: ${t.error}`] : t instanceof Error && void 0
    ...
    function bn(t, e) {
        return me(t?.constructor?.child, e) && t["*"];
    }
    function yn(t, e, n) {
        if (n & E) {
            if (t?.constructor?.child?.child === e.child && t["*"]) return !0;
            if (n & M && bn(t, e.child)) return !0;
        }
        return !1;
    }
    Me({
        defineErrorUnion(t, e) {
            const {instance: {members: [n, r]}, flags: o} = t, {get: c, set: a} = this.defineMember(n), {get: l, set: u} = this.defineMember(r), {get: f, set: h} = this.defineMember(r, !1), d = n.type === D.Void, g = r.structure.constructor, b = function() {
                ...
                if (we(e, v)) this[_t](e), o & s && (f.call(this) || this[Gt]("copy", 0, e)); else if (e instanceof g[ft] && g(e)) u.call(this, e), 
                b.call(this); else if (void 0 !== e || d) try {
                    ...
                    } else if (ze(e)) u.call(this, e), b.call(this); else {
        ...
        defineFunction(t, n) {
            ...
            return Object.setPrototypeOf(l.prototype, Function.prototype), n.valueOf = n.toJSON = re(Se), 
            l;
        },
        ...
        defineOptional(t, e) {
            const {instance: {members: [n, r]}, flags: o} = t, {get: c, set: a} = this.defineMember(n), {get: l, set: u} = this.defineMember(r), f = n.type === D.Void, h = function(t, e) {
                we(t, d) ? (this[_t](t), o & s && l.call(this) && this[Gt]("copy", tt.Vivificate, t)) : null === t ? (u.call(this, 0), 
        ...
        definePointer(t, n) {
            const {flags: i, byteSize: s, instance: {members: [o]}} = t, {structure: a} = o, {type: l, flags: u, byteSize: f = 1} = a, h = i & V ? s / 2 : s, {get: d, set: g} = this.defineMember({
                ...
                if (bn(n, s)) {
                    ...
                    n = n[st][0];
                } else if (i & E) yn(n, s, i) && (n = s(n[st][0][it])); else if (l === e.Slice && u & C && n) if (n.constructor[lt] === e.Pointer) n = n[pt]?.[it]; else if (n[it]) n = n[it]; else if (n?.buffer instanceof ArrayBuffer && !(n instanceof Uint8Array || n instanceof DataView)) {
                ...
                if (n instanceof s) {
                ...
                } else if (we(n, s)) n = s.call(Ut, n[it]); else if (i & M && i & E && n instanceof s.child) n = s(n[it]); else if (function(t, e) {
                    ...
                    if (n) {
                        ...
                        if (e.child && void 0 !== ye(t, e.child)) return !0;
                    }
                    return !1;
                }(n, s)) {
    ...
    Me({
        definePrimitive(t, e) {
            const {instance: {members: [n]}} = t, r = this.createApplier(t), {get: i, set: s} = this.defineMember(n), o = function(e) {
                if (we(e, c)) this[_t](e); else if (e && "object" == typeof e) {
                    if (0 === r.call(this, e)) {
                        const r = se(n);
        ...
        defineSlice(t, e) {
            const {align: n, flags: r, byteSize: o, name: c, instance: {members: [a]}} = t, {byteSize: l, structure: u} = a, f = this, h = function(t, e, r) {
                ...
                if (we(e, w)) this[it] ? d.call(this, e, e.length) : h.call(this, null, e.length, n), 
        ...
        defineStruct(t, e) {
            const {flags: n, length: r, instance: {members: o}} = t, c = o.find((t => t.flags & _)), a = c && this.defineMember(c), l = this.createApplier(t), u = function(e, r) {
                if (we(e, f)) this[_t](e), n & s && this[Gt]("copy", 0, e); else if (e && "object" == typeof e) l.call(this, e, r); else if ("number" != typeof e && "bigint" != typeof e || !a) {
                    if (void 0 !== e) throw new InvalidInitializer(t, "object", e);
                } else a.set.call(this, e);
            }, f = this.createConstructor(t), b = e[jt].value, y = e[vt].value, p = [];
        ...
        defineUnion(t, e) {
            const {flags: n, instance: {members: r}} = t, o = !!(n & m), c = o ? r.slice(0, -1) : r, a = o ? r[r.length - 1] : null, {get: l, set: u} = this.defineMember(a), {get: f} = this.defineMember(a, !1), h = n & w ? function() {
                ...
                if (we(e, y)) this[_t](e), n & s && this[Gt]("copy", tt.Vivificate, e); else if (e && "object" == typeof e) {
                    let n = 0;
            ...
            }, y = this.createConstructor(t), p = {}, A = e[jt].value, I = e[vt].value, V = [];
            for (const r of c) {
            ...
            return e[Xt] = n & v && {
                value() {
                    return E || this[Gt](En), this[Gt] = Ve, this;
                }
            }, e[Ht] = re(b), e[ht] = n & w && {
                get: l,
                set: u
        ...
        defineVariadicStruct(t, e) {
            ...
            e[Qt] = re((function(t) {
                ...
                for (const [t, n] of s.entries()) {
                    ...
                    if (!r || !s) {
                        throw $e(new InvalidVariadicArgument, o + t);
                    }
                    s > i && (i = s);
        ...
        defineVector(t, e) {
            const {flags: n, length: r, instance: {members: [o]}} = t, c = this.createApplier(t), a = function(e) {
                if (we(e, l)) this[_t](e), n & s && this[Gt]("copy", tt.Vivificate, e); else if (e?.[Symbol.iterator]) {
                    let n = e.length;
            ...
            return e.$ = {
                get: Se,
                set: a
            }, e.length = re(r), n & F && (e.typedArray = this.defineTypedArray(t), n & N && (e.clampedArray = this.defineClampedArray(t))), 
