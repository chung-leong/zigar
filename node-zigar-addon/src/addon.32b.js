(function(t) {
    ...
    const e = {
        ...
        VariadicStruct: 13,
        Function: 14
    }, n = Object.keys(e), r = 1, i = 2, s = 4, o = 8, c = 16, a = 16, l = 32, u = 64, f = 128, h = 64, d = 128, g = 256, p = 512, b = 1024, y = 2048, m = 8192, w = 16384, v = 16, S = 32, A = 64, I = 512, M = 16, V = 16, E = 16, x = 32, O = 64, $ = 128, T = 256, U = 16, z = 32, C = 64, B = 128, F = 256, j = 16, k = 16, N = 16, P = 32, L = 16, D = 32, R = 64, Z = {
        Void: 0,
        Bool: 1,
        Int: 2,
        Uint: 3,
    ...
    Ue({
        ...
        invokeThunk(t, e, n) {
            const r = this.startContext(), i = n[Ft], s = this.getViewAddress(t[ct]), o = this.getViewAddress(e[ct]), c = ee in n, a = Yt in n;
    ...
    const We = Object.getOwnPropertyDescriptors, He = Object.defineProperty;
    function Ye(t) {
        const e = t[yt];
    ...
    function Xe(t, e = []) {
        ...
        for (const [r, i] of Object.entries(n)) i.set && !e.includes(r) && (i.set = je, 
        He(t, r, i));
        He(t, Ct, {
            value: t
        });
    ...
    Ue({
        ...
        defineMemberObject: t => hn(t.slot, {
            get: t.flags & Y ? pn : t.structure.flags & r ? dn : gn,
            set: t.flags & J ? je : bn
        })
    }), Ue({
        ...{
    ...
    Ue({
        defineArray(t, e) {
            const {length: n, instance: {members: [r]}, flags: o} = t, c = this.createApplier(t), a = this.defineMember(r), {set: h} = a, d = this.createConstructor(t), g = function(e, r) {
                if (Me(e, d)) this[Xt](e), o & s && this[Yt]("copy", rt.Vivificate, e); else if ("string" == typeof e && o & l && (e = {
                    string: e
                }), e?.[Symbol.iterator]) {
        ...
        defineErrorSet(t, n) {
            ...
            return n.$ = s, n[Qt] = ce((function(e) {
                if (e instanceof l[gt]) o.call(this, e); else if (e && "object" == typeof e && !ke(e)) {
        ...
        finalizeErrorSet(t, e) {
            ...
            e[ne] = {
                value: t => "number" == typeof t || "string" == typeof t ? n[t] : t instanceof n[gt] ? n[Number(t)] : ke(t) ? n[`Error: ${t.error}`] : t instanceof Error && void 0
    ...
    Ue({
        defineErrorUnion(t, e) {
            const {instance: {members: [n, r]}, flags: o} = t, {get: c, set: a} = this.defineMember(n), {get: l, set: u} = this.defineMember(r), {get: f, set: h} = this.defineMember(r, !1), d = n.type === Z.Void, g = r.structure.constructor, p = function() {
                ...
                if (Me(e, v)) this[Xt](e), o & s && (f.call(this) || this[Yt]("copy", 0, e)); else if (e instanceof g[gt] && g(e)) u.call(this, e), 
        ...
        defineOptional(t, e) {
            const {instance: {members: [n, r]}, flags: o} = t, {get: c, set: a} = this.defineMember(n), {get: l, set: u} = this.defineMember(r), f = n.type === Z.Void, h = function(t, e) {
                Me(t, d) ? (this[Xt](t), o & s && l.call(this) && this[Yt]("copy", rt.Vivificate, t)) : null === t ? (u.call(this, 0), 
        ...
        definePointer(t, n) {
            const {flags: i, byteSize: s, instance: {members: [o]}} = t, {structure: a} = o, {type: l, flags: u, byteSize: f = 1} = a, h = i & E ? s / 2 : s, {get: d, set: g} = this.defineMember({
                ...
                if (Sn(n, s)) {
                    ...
                    n = n[at][0];
                } else if (i & x) An(n, s, i) && (n = s(n[at][0][ct])); else if (l === e.Slice && u & F && n) if (n.constructor[ht] === e.Pointer) n = n[vt]?.[ct]; else if (n[ct]) n = n[ct]; else if (n?.buffer instanceof ArrayBuffer && !(n instanceof Uint8Array || n instanceof DataView)) {
            ...
            return n["*"] = {
                ...
                set: v
            }, n[Yt] = this.defineVisitor(), n[Et] = ce(0), n[xt] = ce(0), n[At] = i & E && ce(null), 
    ...
    Ue({
        ...
        defineStruct(t, e) {
            const {flags: n, length: r, instance: {members: o}} = t, c = o.find((t => t.flags & H)), a = c && this.defineMember(c), l = this.createApplier(t), u = function(e, r) {
                if (Me(e, f)) this[Xt](e), n & s && this[Yt]("copy", 0, e); else if (e && "object" == typeof e) l.call(this, e, r); else if ("number" != typeof e && "bigint" != typeof e || !a) {
        ...
        defineUnion(t, e) {
            const {flags: n, instance: {members: r}} = t, o = !!(n & v), c = o ? r.slice(0, -1) : r, a = o ? r[r.length - 1] : null, {get: l, set: u} = this.defineMember(a), {get: f} = this.defineMember(a, !1), h = n & S ? function() {
                ...
                if (Me(e, b)) this[Xt](e), n & s && this[Yt]("copy", rt.Vivificate, e); else if (e && "object" == typeof e) {
                    let n = 0;
            ...
            return e[te] = n & A && {
                value() {
                    return V || this[Yt](Un), this[Yt] = $e, this;
                }
            }, e[Qt] = ce(p), e[pt] = n & S && {
                get: l,
                set: u
        ...
        defineVector(t, e) {
            const {flags: n, length: r, instance: {members: [o]}} = t, c = this.createApplier(t), a = function(e) {
                if (Me(e, l)) this[Xt](e), n & s && this[Yt]("copy", rt.Vivificate, e); else if (e?.[Symbol.iterator]) {
                    let n = e.length;
    ...
    return Ue({
        ...
        defineVisitorVariadicStruct(t) {
            ...
            return {
                value(t, e, r) {
                    if (!(e & rt.IgnoreArguments)) for (const [i, s] of Object.entries(this[at])) i !== n && Yt in s && zn.call(this, i, t, e | rt.IsImmutable, r);
