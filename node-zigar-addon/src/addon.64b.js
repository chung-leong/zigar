(function(t) {
    ...
    function ze(t) {
        return Ue.constructor || Ue.mixins.push(t), t;
    }
    function Ce() {
        return Ue.constructor || (Ue.constructor = function(t, e) {
            const n = [], r = function() {
    ...
    ze({
        ...
        init() {
            this.generatorCallbackMap = new Map, this.generatorInstanceMap = new Map, this.nextGeneratorInstanceId = we(8192);
        },
    ...
    ze({
                ...
                if (n) {
                    if (void 0 === n.misaligned) {
                        ...
                        for (const e of n.targets) {
                            const r = e[ct].byteOffset, i = e.constructor[zt], s = ve(t, r);
                            if (pe(s, i)) {
                                n.misaligned = !0;
                                break;
                            }
        ...
        init() {
            this.promiseCallbackMap = new Map, this.promiseInstanceMap = new Map, this.nextPromiseInstanceId = we(4096);
        },
        createPromise(t, e, n) {
            const {constructor: r} = t;
            if (n) {
        ...
        getPointerName(t) {
            ...
            if (n.structure.type === e.Slice && (s = s.slice(3)), r & E && (i = r & x ? "[]" : r & O ? "[*c]" : "[*]"), 
            !(r & O)) {
    ...
    ze({
        ...
        definePointer(t, n) {
            const {flags: i, byteSize: s, instance: {members: [o]}} = t, {structure: a} = o, {type: l, flags: u, byteSize: f = 1} = a, h = i & x ? s / 2 : s, {get: d, set: g} = this.defineMember({
                type: Z.Uint,
                bitOffset: 0,
                bitSize: 8 * h,
                byteSize: h,
            ...
            }), {get: p, set: b} = i & x ? this.defineMember({
                type: Z.Uint,
                bitOffset: 8 * h,
                bitSize: 8 * h,
                byteSize: h,
                ...
                g.call(this, t), this[xt] = t;
            }, w = u & U ? 1 : 0, v = i & x || u & U ? function(t) {
            ...
            return n["*"] = {
                ...
                set: function(t) {
                    ...
                    const n = e[ct], r = n[ut];
                    let s;
                    if (!r) if (i & x) this[At] ||= e.length, s = this[At]; else {
    ...
    ze({
        definePrimitive(t, e) {
            const {instance: {members: [n]}} = t, r = this.createApplier(t), {get: i, set: s} = this.defineMember(n), o = function(e) {
                if (Ve(e, c)) this[Xt](e); else if (e && "object" == typeof e) {
                    if (0 === r.call(this, e)) {
                        const r = le(n);
        ...
        finalizePrimitive(t, e) {
            ...
            e[Ut] = ce(n.bitSize), e[jt] = ce(n.type);
        }
    }), ze({
        defineSlice(t, e) {
    ...
    const Fn = {
        ...
        reset() {
            this[at][0] = void 0, this[xt] = void 0;
        }
    };
    return ze({
        defineVisitorArgStruct(t) {
            ...
            return {
                value(t, r, i) {
                    if (!(r & rt.IgnoreArguments) && e.length > 0) for (const n of e) Cn.call(this, n, t, r | rt.IsImmutable, i);
                    r & rt.IgnoreRetval || void 0 === n || Cn.call(this, n, t, r, i);
                }
            };
        }
    }), ze({
        ...
        defineVisitorErrorUnion(t, e) {
            ...
            return {
                value(t, r, i) {
                    e.call(this) && (r |= rt.IsInactive), r & rt.IsInactive && r & rt.IgnoreInactive || Cn.call(this, n, t, r, i);
                }
            };
        }
    }), ze({
            ...
            return {
                value(t, r, i) {
                    ...
                    for (const {index: e, slot: o} of n) {
                        let n = r;
                        e !== s && (n |= rt.IsInactive), n & rt.IsInactive && n & rt.IgnoreInactive || Cn.call(this, o, t, n, i);
                    }
                }
            };
        }
