...
describe('Structure: pointer', function() {
  ...
  describe('defineStructure', function() {
    ...
    it('should handle const pointer correct when there is no target', function() {
      ...
      const structure = {
        type: StructureType.Pointer,
        flags: StructureFlag.HasPointer | StructureFlag.HasObject | StructureFlag.HasProxy | StructureFlag.HasSlot | PointerFlag.IsSingle | PointerFlag.IsConst | PointerFlag.IsNullable,
        byteSize: 4,
        signature: 0n,
        instance: {
          members: [
    ...
    it('should automatically create slice object', function() {
      ...
      const sliceStructure = {
        ...
        flags: StructureFlag.HasObject | StructureFlag.HasProxy | StructureFlag.HasSlot,
        name: '[_]Hello',
        byteSize: 8,
        signature: 0n,
        instance: {
    ...
    it('should get address and length of slice pointer with sentinel from memory', function() {
      ...
      const sliceStructure = {
        type: StructureType.Slice,
        flags: StructureFlag.HasProxy | SliceFlag.HasSentinel,
        name: '[_:0]Int32',
        byteSize: 4,
        signature: 0n,
        instance: {
      ...
      const structure = {
        type: StructureType.Pointer,
        flags: StructureFlag.HasPointer | StructureFlag.HasObject | StructureFlag.HasProxy | StructureFlag.HasSlot | PointerFlag.IsMultiple,
        name: '[*:0]Int32',
        byteSize: addressByteSize,
        signature: 0n,
        instance: {
    ...
    it('should allow anyopaque pointer to point at anything', function() {
      ...
      const sliceStructure = {
        type: StructureType.Slice,
        flags: StructureFlag.HasProxy | SliceFlag.IsOpaque,
        byteSize: 1,
        signature: 0n,
        instance: {
          members: [
    ...
    it('should allow C pointer to point at a single object', function() {
      ...
      const cpStructure = {
        type: StructureType.Pointer,
        flags: StructureFlag.HasPointer | StructureFlag.HasObject | StructureFlag.HasProxy | StructureFlag.HasSlot | PointerFlag.IsSingle | PointerFlag.IsMultiple | PointerFlag.IsNullable,
        name: '[*c]i32',
        byteSize: addressByteSize,
        signature: 0n,
        instance: {
