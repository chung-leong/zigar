...
describe('Member: toJSON', function() {
  describe('defineToJSON', function() {
    it('should return descriptor for toJSON', function() {
      const env = new Env();
      const toJSON = env.defineToJSON();
      expect(toJSON.value).to.be.a('function');
    })
  })
  describe('defineStructure', function() {
    it('should attach toJSON method to structure', function() {
      const env = new Env();
    ...
    it('should omit inaccessible pointer', function() {
      const env = new Env();
